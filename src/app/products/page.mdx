...
## Create a product {{ tag: 'POST', label: '/product - ONLY ADMIN' }}
...
<Row>
  ...
  <Col sticky>
    ...
    "product": {
        ...
        "name": "Lego Star Wars Tatooine Toy",
...
<Row>
  <Col>
    ...
    This endpoint allows you to retrieve a product by providing the product id. Refer to [the list](#the-conversation-model) at the top of this page to see which properties are included with product objects.
