...
## List all orders {{ tag: 'GET', label: '/orders - ONLY ADMIN' }}
...
## Retrieve an order {{ tag: 'GET', label: '/orders/:id - ONLY ADMIN AND USER WHO ORDERED' }}
...
## Delete a message {{ tag: 'DELETE', label: '/orders/:id - ONLY ADMIN AND USER WHO ORDERED' }}
